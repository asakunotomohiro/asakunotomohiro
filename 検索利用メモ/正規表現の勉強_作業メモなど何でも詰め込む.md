...
<details><summary>アンカーは、独自に作られている部分があり、個別に調べた方が良い</summary>
  ...
  * アンカー  
    ...
    * [`\b`](#regularLanguageGeneraltermAnchorpeculiarlowercaseb)  
      単語の境界にマッチ。  
...
```
境界というのは[ワード`\w`](#regularLanguageGeneraltermCharacterclassescapetable)のこと。  

以下、単語先頭の境界として`\b`記号を使った結果。
```perl
use v5.24;
