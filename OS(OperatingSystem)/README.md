...
鍵管理サーバの[検索結果](https://keys.openpgp.org/search?q=2771F0FCF8FE74CD9B9C25439D4893D18D358530)を取得。  
...
$ ssh -T git@github.com
Enter passphrase for key '/Users/asakunotomohiro/.ssh/asakunotomohiro_github':	←☆本来ならば、SSHのパスフレーズを入力する。
...
$
```
書き込むファイルは**openpgp.md**が一般的なのだろう。  
