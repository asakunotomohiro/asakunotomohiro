...
* VPNの接続種類(プロトコル)  
  ...
  * [OpenVPN](https://www.openvpn.jp/introduction/)  
    ...
    TODO: オープンソースプロジェクトのライセンスを考慮すること。  
...
gpg/card> passwd
gpg: OpenPGPカードno. D2760001240103040006210273540000を検出
...
<a id="operatingsystemnetwork_mail_serviceforwardemail"></a>
##### forwardemail(メール送受信をフォワードするサービス)
