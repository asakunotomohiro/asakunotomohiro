...
あなたの選択は? q
ご希望の楕円曲線を選択してください:
   (1) Curve 25519	←☆他のに比べて暗号強度が弱い。
   (3) NIST P-256
   (4) NIST P-384
   (5) NIST P-521	←☆これが現時点の最強選択肢。ゆえにこれを選ぶ。
   (6) Brainpool P-256
   (7) Brainpool P-384
...
コメント: pgp@セキュアメールNIST_P-521_20230512	←☆コメントは不要らしいが、他のPGPメールアカウントと区別できるコメントを付けた。
あなたは文字集合'utf-8'を使っています。
次のユーザIDを選択しました:
    "asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>"
...
pub   nistp521 2023-05-12 [C]
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B
uid                      asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>

$
```
最後に出てきたメッセージの「**gpg: 失効証明書を〜〜〜に保管しました。**」と言うファイルは最後に削除する(当然秘密鍵と一緒に別途保管後に実施)。  
コメントは後から修正できないのだろう(できると思っていたので後悔している)。  
...
sec   nistp521 2023-05-12 [C]
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B	←☆主鍵に登録したメールアドレスから副鍵を作る。
uid           [  究極  ] asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>

$ gpg --edit-key --expert 5255752FC2D0110CF8611CF5635EC3A6D7233F2B	←☆作り直しなので、一意になる指紋鍵を指定。
...
sec  nistp521/635EC3A6D7233F2B
     作成: 2023-05-12  有効期限: 無期限      利用法: C
     信用: 究極        有効性: 究極
[  究極  ] (1). asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
...
鍵の有効期限を指定してください。
      ...
      <n>w = 鍵は n 週間で期限切れ
      <n>m = 鍵は n か月間で期限切れ
      <n>y = 鍵は n 年間で期限切れ	←☆副鍵の場合は期限を決めることにより、突然死にも対応できるようにしている。
鍵の有効期間は? (0)10	←☆10年にするはずが間違えた。
鍵は月  5/22 23:31:21 2023 JSTで期限切れとなります	←☆後日10年に変更した。
これで正しいですか? (y/N) y
本当に作成しますか? (y/N) y
たくさんのランダム・バイトの生成が必要です。キーボードを打つ、マウスを動か
す、ディスクにアクセスするなどの他の操作を素数生成の間に行うことで、乱数生
...
sec  nistp521/635EC3A6D7233F2B
     作成: 2023-05-12  有効期限: 無期限      利用法: C
     信用: 究極        有効性: 究極
ssb  cv25519/34C8790D7B0D771F
     作成: 2023-05-12  有効期限: 2023-05-22  利用法: E
[  究極  ] (1). asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
...
```terminal
$ gpg -K --with-subkey-fingerprint asakuno.secure@pgp.asakuno.org
sec   ed25519 2023-04-21 [SC]	←☆主鍵(2種類の機能有り：Cは鍵に対する署名・Sはファイルに対する署名)。
      993B74F887EF3B8F080911044C20892B88F7F574
uid           [  究極  ] asakunotomohiro (pgp@securemail) <asakuno.secure@pgp.asakuno.org>
ssb   cv25519 2023-04-21 [E] [有効期限: 2028-04-19]	←☆副鍵(1種類の機能有り：Eは暗号化)。
      31EC0D189C70A1AADB546650A86D2576AAA988CC
ssb   ed25519 2023-04-30 [S] [有効期限: 2026-04-29]
      06ED9B3E20676E623DE917DE00889BFF44F3F5EB
...
sec   nistp521 2023-05-12 [C]
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B
uid           [  究極  ] asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
ssb   cv25519 2023-05-12 [E] [有効期限: 2023-05-22]
      9255DE4648D8AE9A41093FC334C8790D7B0D771F
...
$ gpg --edit-key --expert 5255752FC2D0110CF8611CF5635EC3A6D7233F2B	←☆鍵の編集。
gpg (GnuPG/MacGPG2) 2.2.41; Copyright (C) 2022 g10 Code GmbH
This is free software: you are free to change and redistribute it.
There is NO WARRANTY, to the extent permitted by law.
...
鍵の有効期限を指定してください。
      ...
      <n>y = 鍵は n 年間で期限切れ
鍵の有効期間は? (0)10	←☆10年にするはずが間違えた。
鍵は月  5/22 23:33:02 2023 JSTで期限切れとなります	←☆後日10年に変更した。
これで正しいですか? (y/N) y
本当に作成しますか? (y/N) y
たくさんのランダム・バイトの生成が必要です。キーボードを打つ、マウスを動か
す、ディスクにアクセスするなどの他の操作を素数生成の間に行うことで、乱数生
...
ssb  cv25519/34C8790D7B0D771F
     作成: 2023-05-12  有効期限: 2023-05-22  利用法: E
ssb  ed25519/989852FAEFED9D1F	←☆今回作成した副鍵。
     作成: 2023-05-12  有効期限: 2023-05-22  利用法: S
[  究極  ] (1). asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
...
sec   nistp521 2023-05-12 [C]
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B
uid           [  究極  ] asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
ssb   cv25519 2023-05-12 [E] [有効期限: 2023-05-22]	←☆暗号化のみの副鍵。
      9255DE4648D8AE9A41093FC334C8790D7B0D771F
ssb   ed25519 2023-05-12 [S] [有効期限: 2023-05-22]	←☆署名のみの副鍵。
      16B1356B6B76CE3A8EBB7798989852FAEFED9D1F
...

=pv45
...
sec   nistp521 2023-05-12 [C]
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B	←☆主鍵のみ削除。
uid           [  究極  ] asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
ssb   cv25519 2023-05-12 [E] [有効期限: 2023-05-22]	←☆副鍵は残す。
      9255DE4648D8AE9A41093FC334C8790D7B0D771F
ssb   ed25519 2023-05-12 [S] [有効期限: 2023-05-22]	←☆副鍵は残す。
      16B1356B6B76CE3A8EBB7798989852FAEFED9D1F

$ gpg --delete-secret-key 5255752FC2D0110CF8611CF5635EC3A6D7233F2B	←☆鍵の削除。
gpg (GnuPG/MacGPG2) 2.2.41; Copyright (C) 2022 g10 Code GmbH
This is free software: you are free to change and redistribute it.
There is NO WARRANTY, to the extent permitted by law.


sec  nistp521/635EC3A6D7233F2B 2023-05-12 asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
...
gpg: 5255752FC2D0110CF8611CF5635EC3A6D7233F2B: delete key failed: 操作がキャンセルされました	←☆主鍵は消すが、副鍵削除せず。
$
```
...
sec#  nistp521 2023-05-12 [C]	←☆主鍵(秘密鍵がない場合シャープ記号が付く)。
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B
uid           [  究極  ] asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
ssb   cv25519 2023-05-12 [E] [有効期限: 2023-05-22]	←☆副鍵。
      9255DE4648D8AE9A41093FC334C8790D7B0D771F
ssb   ed25519 2023-05-12 [S] [有効期限: 2023-05-22]	←☆副鍵。
      16B1356B6B76CE3A8EBB7798989852FAEFED9D1F
...
sec#  nistp521 2023-05-12 [C]	←☆主鍵は端末から削除済みを示すシャープ記号が付いている。
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B
uid           [  究極  ] asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
ssb   cv25519 2023-05-12 [E] [有効期限: 2033-05-12]	←☆10年後まで有効。
      9255DE4648D8AE9A41093FC334C8790D7B0D771F	←☆副鍵のフィンガープリント。
ssb   ed25519 2023-05-12 [S] [有効期限: 2033-05-13]	←☆10年後まで有効。
      16B1356B6B76CE3A8EBB7798989852FAEFED9D1F	←☆副鍵のフィンガープリント。
...
ssb   cv25519 2023-05-12 [E] [有効期限: 2023-05-22]
      9255DE4648D8AE9A41093FC334C8790D7B0D771F
ssb   ed25519 2023-05-12 [S] [有効期限: 2023-05-22]
      16B1356B6B76CE3A8EBB7798989852FAEFED9D1F

$ gpg --edit-key 5255752FC2D0110CF8611CF5635EC3A6D7233F2B	←☆鍵の編集。
gpg (GnuPG/MacGPG2) 2.2.41; Copyright (C) 2022 g10 Code GmbH
This is free software: you are free to change and redistribute it.
There is NO WARRANTY, to the extent permitted by law.
...
pub  nistp521/635EC3A6D7233F2B
     作成: 2023-05-12  有効期限: 無期限      利用法: C
     信用: 究極        有効性: 究極
ssb  cv25519/34C8790D7B0D771F	←☆副鍵のパスフレーズのみ変更。
     作成: 2023-05-12  有効期限: 2023-05-22  利用法: E
ssb  ed25519/989852FAEFED9D1F	←☆副鍵のパスフレーズのみ変更。
     作成: 2023-05-12  有効期限: 2023-05-22  利用法: S
[  究極  ] (1). asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>

gpg> passwd	←☆パスフレーズ変更(パスワードコマンドでパスフレーズ変更？)。
gpg: 鍵 635EC3A6D7233F2B/635EC3A6D7233F2B: パスフレーズの変更エラー: 秘密鍵がありません	←☆削除済みであるため、気にしない。
...
sec   nistp521 2023-05-12 [C]	←☆主鍵は削除しておいた方がいい(勘違いで残したまま作業した)。
      5255752FC2D0110CF8611CF5635EC3A6D7233F2B
uid           [  究極  ] asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
ssb   cv25519 2023-05-12 [E] [有効期限: 2023-05-22]	←☆暗号化に特化した鍵。
      9255DE4648D8AE9A41093FC334C8790D7B0D771F
ssb   ed25519 2023-05-12 [S] [有効期限: 2023-05-22]	←☆署名に特化した鍵。
      16B1356B6B76CE3A8EBB7798989852FAEFED9D1F

$ keybase pgp select --import --multi asakuno.secure@pgp.asakuno.org	←☆個人的には2種類の鍵を持ち込むつもりだったが、そんな選択肢は出てこなかった(理由：公開鍵は1種類のみだから)。
You are selecting a PGP key to publish in your profile, and
importing secret key to *local*, *encrypted* Keybase keyring.
...
#    Algo   Key Id             Created   UserId
=    ====   ======             =======   ======
1    521E   635EC3A6D7233F2B             asakunotomohiro <asakuno.secure@pgp.asakuno.org>
Choose a key: 1
▶ INFO Generated new PGP key:	←☆署名鍵を使う(これができずにKeybaseに鍵を付けられなかった)。
▶ INFO   user: asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>
▶ INFO   521-bit ECDSA key, ID 635EC3A6D7233F2B, created 2023-05-12
$
```
...
```terminal
$ keybase pgp select --import --multi 993B74F887EF3B8F080911044C20892B88F7F574
You are selecting a PGP key to publish in your profile, and
importing secret key to *local*, *encrypted* Keybase keyring.
...
$ gpg --keyserver keys.openpgp.org --send-keys 5255752FC2D0110CF8611CF5635EC3A6D7233F2B	←☆鍵を鍵サーバに登録。
gpg: 鍵635EC3A6D7233F2Bをhkp://keys.openpgp.orgへ送信
$
```
...
$ gpg --keyserver keys.openpgp.org --search-keys asakuno.secure@pgp.asakuno.org
gpg: data source: http://keys.openpgp.org:11371
(1) asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakun
    521 bit ECDSA key 635EC3A6D7233F2B, 作成: 2023-05-12
Keys 1-1 of 1 for "asakuno.secure@pgp.asakuno.org".  番号(s)、N)次、またはQ)中止を入力してください >1
gpg: 鍵635EC3A6D7233F2B:"asakunotomohiro (pgp@セキュアメールNIST_P-521_20230512) <asakuno.secure@pgp.asakuno.org>"変更なし
gpg:           処理数の合計: 1
gpg:               変更なし: 1
$
```
