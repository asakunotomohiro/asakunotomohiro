...
そもそもサクラエディタの場合は、[外部DLL](http://k-takata.o.oo7.jp/mysoft/bregonig.html)を使っているようだが、そんなことはどうでもいい(その外部DLLもまた[派生した](http://www.hi-ho.ne.jp/babaq/bregexp.html)もののようだ)。
だからなんだって話だが・・・。  
...
1. [メタキャラクタリファレンス](#regularDesktopReference3000001)
   ...
   1. [$ 文字列の末尾、または行終端子の直前にマッチ](#regularDesktopReference3030108)  
