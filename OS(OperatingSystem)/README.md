...
* 導入アドオン  
  ...
  メールのエクスポートやインポートを行う(PGP送受信では暗号化されたままエクスポートする)。  
  ※[元の開発](https://addons.thunderbird.net/ja/thunderbird/addon/importexporttools/)からフォークされたバージョンということで、**NextGen**の頭文字をとって、**NG**なんだ(NGを別の意味で捉えたよ)。  
