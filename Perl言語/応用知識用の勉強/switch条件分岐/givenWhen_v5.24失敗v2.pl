...
sub asakunoSwitch {
	...
	given ($val) {
		# given is experimental at givenWhen_v5.24失敗v2.pl line 5.
			when (1)        { print "number 1" }	# when is experimental at givenWhen_v5.24失敗v2.pl line 7.
			when ("a")      { print "string a" }	# when is experimental at givenWhen_v5.24失敗v2.pl line 8.
