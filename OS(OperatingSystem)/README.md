...
gpg: 深さ: 0  有効性:  16  署名:   0  信用: 0-, 0q, 0n, 0m, 0f, 16u
...
秘密鍵から作れるため、保管せずに削除してかまわない(私はそうしている)。  
...
asakunotomohiro has logged off s027 from .
$ gpg -K --with-subkey-fingerprint asakuno.secure@pgp.asakuno.org
gpg: 信用データベースの検査
gpg: marginals needed: 3  completes needed: 1  trust model: pgp
gpg: 深さ: 0  有効性:  14  署名:   0  信用: 0-, 0q, 0n, 0m, 0f, 14u
...
gpg: 信用データベースの検査
gpg: marginals needed: 3  completes needed: 1  trust model: pgp
gpg: 深さ: 0  有効性:  17  署名:   0  信用: 0-, 0q, 0n, 0m, 0f, 17u
...
gpg> save	←☆作成した副鍵の保存。
asakunotomohiro has logged off s021 from .
$ gpg -K --with-subkey-fingerprint asakuno.secure@pgp.asakuno.org
sec   ed25519 2023-05-22 [C]
      2771F0FCF8FE74CD9B9C25439D4893D18D358530
uid           [  究極  ] asakunotomohiro (securemail@セキュアメール) <asakuno.secure@pgp.asakuno.org>
...
gpg> save
asakunotomohiro has logged off s026 from .
$ gpg -K --with-subkey-fingerprint asakuno.secure@pgp.asakuno.org
sec   ed25519 2023-05-22 [C]
      2771F0FCF8FE74CD9B9C25439D4893D18D358530
uid           [  究極  ] asakunotomohiro (securemail@セキュアメール) <asakuno.secure@pgp.asakuno.org>
...
$ keybase pgp list	←☆出てきていない(要は登録失敗)。
$
...
$ gpg --quick-set-expire 2771F0FCF8FE74CD9B9C25439D4893D18D358530 2110-09-03
gpg: '2110-09-03'は、有効な有効期限ではありません
$ gpg --quick-set-expire 2771F0FCF8FE74CD9B9C25439D4893D18D358530 2109-05-03
gpg: '2109-05-03'は、有効な有効期限ではありません
$ gpg --quick-set-expire 2771F0FCF8FE74CD9B9C25439D4893D18D358530 2100-05-03
$ gpg --quick-set-expire 2771F0FCF8FE74CD9B9C25439D4893D18D358530 2101-05-03
$ gpg --quick-set-expire 2771F0FCF8FE74CD9B9C25439D4893D18D358530 2102-05-03
$ gpg --quick-set-expire 2771F0FCF8FE74CD9B9C25439D4893D18D358530 2103-05-03
...
gpg: *警告*: サーバ'dirmngr'はこちらより古いです(2.2.41 < 2.4.1)
...
　　　・
　　　・
▶ ERROR Key 01166587a59e606e8eb195db87c2887f933a02af58d8e90e6538780b3f749b57b8000a is not active in user's sigchain. Publish key first to be able to import to local Keybase keychain
$
```
...
```text
　　　;
▶ [DEBU keybase gpg_cli.go:405] 12f | running Gpg: /usr/local/bin/gpg --no-auto-check-trustdb --armor --sign -u 01166587a59e606e8eb195db87c2887f933a02af58d8e90e6538780b3f749b57b8000a
...
以下、やり直しとして、公開することにした作業。
    ...
    1    256?   9D4893D18D358530             asakunotomohiro <asakuno.secure@pgp.asakuno.org>
    Choose a key: 1
    今回出てこなかった☆→	▶ INFO Generated new PGP key:	←☆署名鍵を使う(これができずにKeybaseに鍵を付けられなかった)。
    今回出てこなかった☆→	▶ INFO   user: asakunotomohiro (pgp@セキュアメール) <asakuno.secure@pgp.asakuno.org>
    今回出てこなかった☆→	▶ INFO   521-bit ECDSA key, ID E1AE542959117853, created 2023-05-13
    $ keybase pgp list	←☆キーベースへの登録一覧(登録前に実行してみればよかった)。
    今回出てこなかった☆→	Keybase Key ID:  01136807c6380c437cd4f00af9b0a84b28fcc3cb05c1c1ceac3364114abfb33a523b0a
    今回出てこなかった☆→	PGP Fingerprint: 736a270643e90e1c99d470c6e1ae542959117853
    今回出てこなかった☆→	PGP Identities:
    今回出てこなかった☆→	   asakunotomohiro (pgp@セキュアメール) <asakuno.secure@pgp.asakuno.org>
