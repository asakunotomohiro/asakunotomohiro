...
sub tomohiro() {
	...
	my @stat_entity = lstat($entity);	# ファイルのlstat情報。;
...
&tomohiro(@ARGV);
# 出力結果：
#			以下、lstat情報を実体ファイルとシンボリックリンクファイルで比較した。
#			実体(16777220)==リンクファイル(16777220) ←0 dev ファイルのデバイス番号
#			実体(67648353)!=リンクファイル(67648354) ←1 ino ファイルのiノード番号
...
#			実体(1642646572)!=リンクファイル(1642646573) ←8 atime 最終アクセス時刻
#			実体(1642646572)!=リンクファイル(1642646573) ←9 mtime 最終更新時刻
#			実体(1642646572)!=リンクファイル(1642646573) ←10 ctime 最後のinode変更時刻
