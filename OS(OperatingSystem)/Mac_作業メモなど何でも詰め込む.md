...
* 手順  
  ...
  1. メインハードディスクを消去する。  
     私の環境でのハードディスク名は、「**APPLE HDD HTS54541010A9E662 Media**」と表記されている。  
     これは私が任意で付けた名前か？ネット検索しても出てこなかった。  
     そして、今時1TBしかないという・・・少ない。  
     ...
     ※「消去プロセスを完了できませんでした。続けるには、"完了"をクリックします。」が出てきて作業を進められず。  
